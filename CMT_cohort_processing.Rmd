...
mutate(
    ...
    gait_abnormalities = ifelse(str_detect(p41270, regex("R2689|R26|R268|R269|R260|R261|R262", ignore_case = TRUE)), 1, 0)
  )
comorbidities <- as.data.frame(subset(comorbidities, select = -c(p41270, p41272, p120037)))
